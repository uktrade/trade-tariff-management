...
class CreateMeasurePage < CreateMeasurePageElements
  ...
  element :duty_amount, "input#measure-component-0-amount.form-control"
  elements :foot_note_type, "div.selectize-input.items.has-options.full.has-items"
  elements :select_foot_note_option, "span.selection.active"
  ...
  def select_condition_type(condition_type, index)
    position = index
    within("#content fieldset:nth-child(4) #measure-condition-#{position}-condition") do
  ...
  def select_certificate_type(certificate_type, index)
    position = index
    within("#content fieldset:nth-child(4) #measure-condition-#{position}-certificate-type") do
  ...
  def select_certificate(certificate, index)
    position = index
    within("#content fieldset:nth-child(4) #measure-condition-#{position}-certificate") do
  ...
  def select_condition_action(action, index)
    position = index
    within("#content fieldset:nth-child(4) #measure-condition-#{position}-action") do
  ...
  def select_condition_duty_expression(duty_expression, index)
    position = index
    within("#content fieldset:nth-child(4) #measure-condition-#{position}-measure-condition-component-0-duty-expression") do
  ...
  def select_duty_expression(duty_expression)
    within("#content fieldset:nth-child(6) .measure-components #measure-component-0-duty-expression") do
      select_dropdown_value(duty_expression)
    end
  end
...
def select_unit_of_measure(unit)
  within("#content fieldset:nth-child(6) .measure-components #measure-component-0-measurement-unit") do
    select_dropdown_value(unit)
  end
end

def select_qualifier(qualifier)
  within("#content fieldset:nth-child(6) .measure-components #measure-component-0-measurement-unit-qualifier") do

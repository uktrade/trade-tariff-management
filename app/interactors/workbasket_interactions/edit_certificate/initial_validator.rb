module WorkbasketInteractions
  module EditCertificate
    class InitialValidator
      ...
      def initialize(original_certificate, settings)
        @errors = {}
    ...
    private
      ...
      def check_description!
        ...
        if description.length > 500
          ...
          @errors_summary = errors_translator(:description_max_limit)
        end
      end
      ...
      def description_does_not_match_original_description?
        description.squish != original_certificate.description.squish
      end
    end
  end
end

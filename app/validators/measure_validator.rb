class MeasureValidator < TradeTariffBackend::Validator
  ...
  #         record.generating_regulation_id.present? &&
  #         record.generating_regulation.effective_end_date.present?

  #       valid = record.generating_regulation.effective_end_date >= record.validity_end_date
  #     end
  #   end

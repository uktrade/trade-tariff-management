...
describe "Regulation Form APIs: Regulations", type: :request do
  ...
  context "Index" do
    ...
    it "should return JSON collection of all actual regulation groups" do
      get "/regulation_form_api/base_regulations.json", headers: headers
    ...
    it "should filter regulation groups by keyword" do
      get "/regulation_form_api/base_regulations.json", params: { q: "New classification 2005" }, headers: headers

      expect(collection.count).to eq(1)
      expecting_regulation_in_result(0, actual_base_regulation_i9602220)

      get "/regulation_form_api/base_regulations.json", params: { q: "R971328" }, headers: headers

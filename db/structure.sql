...
CREATE TABLE bulk_edit_of_additional_codes_settings (
    id integer NOT NULL,
    workbasket_id integer,
...
CREATE SEQUENCE bulk_edit_of_additional_codes_settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE bulk_edit_of_additional_codes_settings_id_seq OWNED BY bulk_edit_of_additional_codes_settings.id;
...
CREATE TABLE bulk_edit_of_measures_settings (
    id integer NOT NULL,
    workbasket_id integer,
    main_step_settings_jsonb jsonb DEFAULT '{}'::jsonb,
    main_step_validation_passed boolean DEFAULT false,
...
CREATE SEQUENCE bulk_edit_of_measures_settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE bulk_edit_of_measures_settings_id_seq OWNED BY bulk_edit_of_measures_settings.id;
...
CREATE TABLE bulk_edit_of_quotas_settings (
    id integer NOT NULL,
    workbasket_id integer,
    main_step_settings_jsonb jsonb DEFAULT '{}'::jsonb,
    main_step_validation_passed boolean DEFAULT false,
...
CREATE SEQUENCE bulk_edit_of_quotas_settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE bulk_edit_of_quotas_settings_id_seq OWNED BY bulk_edit_of_quotas_settings.id;
...
CREATE TABLE create_additional_code_workbasket_settings (
    id integer NOT NULL,
    workbasket_id integer,
    main_step_settings_jsonb jsonb DEFAULT '{}'::jsonb,
    main_step_validation_passed boolean DEFAULT false,
...
CREATE SEQUENCE create_additional_code_workbasket_settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE create_geographical_area_workbasket_settings (
    id integer NOT NULL,
    workbasket_id integer,
    main_step_settings_jsonb jsonb DEFAULT '{}'::jsonb,
    main_step_validation_passed boolean DEFAULT false,
...
CREATE SEQUENCE create_geographical_area_workbasket_settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE create_geographical_area_workbasket_settings_id_seq OWNED BY create_geographical_area_workbasket_settings.id;
...
CREATE TABLE create_regulation_workbasket_settings (
    id integer NOT NULL,
    workbasket_id integer,
    main_step_settings_jsonb jsonb DEFAULT '{}'::jsonb,
    main_step_validation_passed boolean DEFAULT false,
...
CREATE SEQUENCE create_regulation_workbasket_settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE create_regulation_workbasket_settings_id_seq OWNED BY create_regulation_workbasket_settings.id;
...
ALTER TABLE ONLY bulk_edit_of_additional_codes_settings ALTER COLUMN id SET DEFAULT nextval('bulk_edit_of_additional_codes_settings_id_seq'::regclass);
...
ALTER TABLE ONLY bulk_edit_of_measures_settings ALTER COLUMN id SET DEFAULT nextval('bulk_edit_of_measures_settings_id_seq'::regclass);
...
ALTER TABLE ONLY bulk_edit_of_quotas_settings ALTER COLUMN id SET DEFAULT nextval('bulk_edit_of_quotas_settings_id_seq'::regclass);
...
ALTER TABLE ONLY create_geographical_area_workbasket_settings ALTER COLUMN id SET DEFAULT nextval('create_geographical_area_workbasket_settings_id_seq'::regclass);
...
ALTER TABLE ONLY create_regulation_workbasket_settings ALTER COLUMN id SET DEFAULT nextval('create_regulation_workbasket_settings_id_seq'::regclass);
...
ALTER TABLE ONLY bulk_edit_of_additional_codes_settings
...
ALTER TABLE ONLY bulk_edit_of_measures_settings
...
ALTER TABLE ONLY bulk_edit_of_quotas_settings
...
ALTER TABLE ONLY create_geographical_area_workbasket_settings
...
ALTER TABLE ONLY create_regulation_workbasket_settings
...
CREATE INDEX measure_conditions_oplog_measure_sid_index ON measure_conditions_oplog USING btree (measure_sid);
...
CREATE INDEX measures_oplog_measure_type_id_index ON measures_oplog USING btree (measure_type_id);
...
CREATE INDEX measures_oplog_ordernumber_index ON measures_oplog USING btree (ordernumber);
...
CREATE INDEX quota_definitions_oplog_quota_order_number_id_index ON quota_definitions_oplog USING btree (quota_order_number_id);
...
CREATE INDEX quota_order_number_origin_exclusions_oplog_quota_order_number_o ON quota_order_number_origin_exclusions_oplog USING btree (quota_order_number_origin_sid);
...
CREATE INDEX quota_order_number_origins_oplog_quota_order_number_sid_index ON quota_order_number_origins_oplog USING btree (quota_order_number_sid);
...
CREATE INDEX quota_order_numbers_oplog_quota_order_number_id_index ON quota_order_numbers_oplog USING btree (quota_order_number_id);
